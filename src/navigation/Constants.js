...
export const BLOGS = '/sd/blogs';
export const PASSWORD_RESET = '/password/reset';
export const CREATE = '/create';
export const CREATE_BLOG = '/create/blog';
export const PROFILE = '/profile';
export const PROFILE_TAB = '/profile/:page';
...
export const USER_PAGE_TAB = '/:username/:page';
export const POST_PAGE = '/post/:id';
export const BLOG_PAGE = '/sd/blogs/:id';
export const BLOG_PAGE_BASE = '/sd/blogs';
