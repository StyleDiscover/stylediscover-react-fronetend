   ...
   return (
      <Container maxWidth="lg" style={{ marginBottom: 25 }}>
         <div className="margin-top-80">
            ...
            <Typography variant="body1">Last updated: 2020-12-22</Typography>
            <br />
            <div>
               <Typography variant="subtitle2">1. Introduction</Typography>
               <Typography variant="body2" align="justify">
                  Welcome to BLOOMBOOK TECHNOLOGY PRIVATE LIMITED (“Company”,
                  “we”, “our”, “us”)! These Terms of Service (“Terms”, “Terms of
                  Service”) govern your use of our website located at
                  https://stylediscover.in/ (together or individually “Service”)
                  operated by BLOOMBOOK TECHNOLOGY PRIVATE LIMITED. Our Privacy
                  Policy also governs your use of our Service and explains how
                  we collect, safeguard and disclose information that results
                  from your use of our web pages. Your agreement with us
                  includes these Terms and our Privacy Policy (“Agreements”).
                  ...
                  Service, but please let us know by emailing at hello@lynck.me
            ...
            <br />
            <div>
               <Typography variant="subtitle2">2. Communications</Typography>
               <Typography variant="body2" align="justify">
                  ...
                  link or by emailing at hello@lynck.me.
               </Typography>
            </div>
            <br />
            <div>
            ...
            <br />
            <div>
               <Typography variant="subtitle2">4. Content</Typography>
               <Typography variant="body2" align="justify">
                  ...
                  your Content subject to these Terms. BLOOMBOOK TECHNOLOGY
                  PRIVATE LIMITED has the right but not the obligation to
                  monitor and edit all Content provided by users. In addition,
                  Content found on or through this Service are the property of
                  BLOOMBOOK TECHNOLOGY PRIVATE LIMITED or used with permission.
                  You may not distribute, modify, transmit, reuse, download,
            ...
            <br />
            <div>
               <Typography variant="subtitle2">5. Prohibited Uses</Typography>
               <Typography variant="body2" align="justify">
            ...
            <br />
            <div>
               <Typography variant="subtitle2">6. Analytics</Typography>
               <Typography variant="body2" align="justify">
            ...
            <br />
            <div>
               <Typography variant="subtitle2">7. No Use By Minors</Typography>
               <Typography variant="body2" align="justify">
            ...
            <br />
            <div>
               <Typography variant="subtitle2">8. Accounts</Typography>
               <Typography variant="body2" align="justify">
            ...
            <div>
               ...
               <Typography variant="body2" align="justify">
                  ...
                  exclusive property of BLOOMBOOK TECHNOLOGY PRIVATE LIMITED and
                  its licensors. Service is protected by copyright, trademark,
                  and other laws of and foreign countries. Our trademarks may
                  not be used in connection with any product or service without
                  the prior written consent of BLOOMBOOK TECHNOLOGY PRIVATE
                  LIMITED.
               </Typography>
            </div>
            <br />
            <div>
               <Typography variant="subtitle2">10. Copyright Policy</Typography>
               <Typography variant="body2" align="justify">
                  ...
                  claim via email to hello@lynck.me, with the subject line:
                  “Copyright Infringement” and include in your claim a detailed
                  description of the alleged Infringement as detailed below,
                  under “DMCA Notice and Procedure for Copyright Infringement
                  Claims” You may be held accountable for damages (including
                  costs and attorneys’ fees) for misrepresentation or bad-faith
            ...
            <div>
               ...
               <Typography variant="body2" align="justify">
                  You may provide us either directly at hello@lynck.me or via
            ...
            <div>
               ...
               <Typography variant="body2" align="justify">
                  ...
                  services that are not owned or controlled by BLOOMBOOK
                  TECHNOLOGY PRIVATE LIMITED. BLOOMBOOK TECHNOLOGY PRIVATE
                  LIMITED has no control over, and assumes no responsibility for
                  the content, privacy policies, or practices of any third party
                  web sites or services. We do not warrant the offerings of any
                  of these entities/individuals or their websites. For example,
                  the outlined Terms of Use have been created using
            ...
            <br />
            <div>
               <Typography variant="subtitle2">16. Termination</Typography>
               <Typography variant="body2" align="justify">
            ...
            <br />
            <div>
               <Typography variant="subtitle2">17. Governing Law</Typography>
               <Typography variant="body2" align="justify">
            ...
            <br />
            <div>
               <Typography variant="subtitle2">21. Acknowledgement</Typography>
               <Typography variant="body2" align="justify">
            ...
            <br />
            <div>
               <Typography variant="subtitle2">22. Contact Us</Typography>
               <Typography variant="body2" align="justify">
                  Please send your feedback, comments, requests for technical
                  support by email: hello@lynck.me.
               </Typography>
               <br />
               <Typography variant="body2" align="justify">
                  These Terms of Service were created for
                  https://stylediscover.in/ by PolicyMaker.io on 2020-12-22.
               </Typography>
            </div>
         </div>
      </Container>
